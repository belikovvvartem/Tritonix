...
function renderProjects(containerId, projectList, basePath) {
    ...
    const projectsHTML = projectList.map(
        ...
        <a href="${project.link}" target="_blank" class="example-link">
            <div class="example">
                <img src="${basePath}${project.image}" alt="${project.title}" class="example-foto">
